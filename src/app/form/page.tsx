    ...
    return (
        <div className="max-w-2xl mx-auto mt-10 p-6 bg-white rounded-lg shadow-md">
            ...
            <form.AppField name="brand">
                {(field) => <field.TextField label="Marque" />}
            </form.AppField>

            <form.AppField name="model">
                {(field) => <field.TextField label="Modèle" />}
            </form.AppField>

            <form.AppField name="technicalCaracteristics">
                {(field) => <field.TextField label="Caractéristiques techniques" isLongText />}
            </form.AppField>

            <form.AppField name="year">
                {(field) => <field.NumberField label="Date de première mise en circulation" />}
            </form.AppField>
